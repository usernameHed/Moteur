...
public:
	...
	virtual float sample(float xBase, float yBase, float zBase)
	{
		...
		YVec3f sommets[8];
		//plan X2
		sommets[0] = YVec3f(x2, y1, z1);
		sommets[1] = YVec3f(x2, y1, z2);
		sommets[2] = YVec3f(x2, y2, z2);
		sommets[3] = YVec3f(x2, y2, z1);

		//plan X1
		sommets[4] = YVec3f(x1, y1, z1);
		sommets[5] = YVec3f(x1, y1, z2);
		sommets[6] = YVec3f(x1, y2, z2);
		sommets[7] = YVec3f(x1, y2, z1);
